...
from typing import Final, Never, Protocol, TypeVar, type_check_only
...
# House override of types-pyyaml: a loaded document is whatever the text held,
# which the stub cannot know. Upstream says ``Any``; ``object`` makes the
# caller's codec or ``isinstance`` the narrowing.
type _YAMLObject = object
