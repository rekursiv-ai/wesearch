...
from typing import ClassVar, Never, Self, TypeVar
...
class BaseRepresenter:
    yaml_representers: ClassVar[
        dict[type[Incomplete], Callable[[BaseRepresenter, Incomplete], Node]]
    ]
    ...
    def represent_mapping(
        self,
        tag: str,
        mapping: SupportsItems[Incomplete, Incomplete]
        | Iterable[tuple[Incomplete, Incomplete]],
        flow_style: bool | None = None,
    ) -> MappingNode: ...
...
class SafeRepresenter(BaseRepresenter):
    ...
    def represent_list(self, data: Iterable[Incomplete]) -> SequenceNode: ...
    def represent_dict(
        self,
        data: SupportsItems[Incomplete, Incomplete]
        | Iterable[tuple[Incomplete, Incomplete]],
    ) -> MappingNode: ...
