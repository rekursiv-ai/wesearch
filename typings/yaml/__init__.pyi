...
def add_constructor(
    tag: str,
    constructor: Callable[[Loader | FullLoader | UnsafeLoader, Node], Incomplete],
    Loader: None = None,
) -> None: ...
@overload
def add_constructor(
    tag: str,
    constructor: Callable[[_Constructor, Node], Incomplete],
...
def add_multi_constructor(
    tag_prefix: str,
    multi_constructor: Callable[[_Constructor, str, Node], Incomplete],
    Loader: type[_Constructor],
) -> None: ...
@overload
def add_representer(
