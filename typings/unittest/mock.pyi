...
# House override of typeshed, which declares ``class NonCallableMock(Base, Any)``
# with ``__getattr__ -> Any``. Pyright resolves attributes through the ``Any``
# base first, so every ``m.method.assert_called_once()`` is an Any expression
# and ``reportAny`` fires on each. Dropping the base types an attribute as the
# child mock it is at runtime. The cost: a mock handed to a typed parameter
# needs ``cast(Conn, mock)`` at that site, which is where the stand-in claim
# belongs.
...
class CallableMixin(Base):
    ...
    def __init__(
        ...
        return_value: object = ...,
        wraps: object | None = None,
        name: str | None = None,
        spec_set: object | None = None,
        parent: NonCallableMock | None = None,
        _spec_state: object | None = None,
        _new_name: str = "",
        _new_parent: NonCallableMock | None = None,
        **kwargs: object,
    ) -> None: ...
...
class AsyncMockMixin(Base):
    ...
    def assert_awaited_with(self, *args: object, **kwargs: object) -> None: ...
    def assert_awaited_once_with(self, *args: object, **kwargs: object) -> None: ...
    def assert_any_await(self, *args: object, **kwargs: object) -> None: ...
...
if sys.version_info >= (3, 13):
    class ThreadingMixin(Base):
        ...
        def __init__(
            ...
            /,
            *args: Any,
            timeout: float | _SentinelObject | None = ...,
            **kwargs: Any,
        ) -> None: ...
        ...
        def wait_until_called(
            self, *, timeout: float | _SentinelObject | None = ...
        ) -> None: ...
